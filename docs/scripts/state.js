...
let commentOrderMode = 'sandwich_paragraph'; // 'sandwich_paragraph' | 'strengths_feedback_blocks' | 'bullet_points'
let savedReports = [];
...
function computePrintColumnWidths(students){
  ...
  const tabMarkingAssistantBtn = document.getElementById('tabMarkingAssistantBtn');
  ...
  const tabSeatingBtn = document.getElementById('tabSeatingBtn');
  ...
  const markingAssistantSection = document.getElementById('markingAssistantSection');
  const phoneLogsSection = document.getElementById('phoneLogsSection');
  const seatingTabSection = document.getElementById('seatingPlanSection');
  ...
  const builderBasicSortSelector = document.getElementById('builderBasicSortSelector');
  ...
  const builderBasicSaveAllBtn = document.getElementById('builderBasicSaveAllBtn');
  ...
  const builderAiOutputWrap = document.getElementById('builderAiOutputWrap');
...
const printAllTemplatesToggle = document.getElementById('printAllTemplatesToggle');
const printAllTemplatesModal = document.getElementById('printAllTemplatesModal');
const allTemplatesMarkingList = document.getElementById('allTemplatesMarkingList');
const allTemplatesMarkingSelectAllBtn = document.getElementById('allTemplatesMarkingSelectAll');
const allTemplatesMarkingClearBtn = document.getElementById('allTemplatesMarkingClear');
...
const bulkUpcomingSearch = document.getElementById('bulkUpcomingSearch');
...
const markingImagePreviewWrap = document.getElementById('markingImagePreviewWrap');
const markingImagePreview = document.getElementById('markingImagePreview');
const markingClearImageBtn = document.getElementById('markingClearImageBtn');
const markingScanBtn = document.getElementById('markingScanBtn');
const markingStatusEl = document.getElementById('markingStatus');
const markingSpinner = document.getElementById('markingSpinner');
const markingResultsEmpty = document.getElementById('markingResultsEmpty');
const markingResultsWrap = document.getElementById('markingResultsWrap');
const markingResultsMeta = document.getElementById('markingResultsMeta');
...
const seatingCommentsBtn = document.getElementById('seatingCommentsBtn');
const seatingBackToDataBtn = document.getElementById('seatingBackToDataBtn');
const seatingRowsInput = document.getElementById('seatingRowsInput');
const seatingColsInput = document.getElementById('seatingColsInput');
const seatingObjectiveSelect = document.getElementById('seatingObjectiveSelect');
const seatingRespectLocksInput = document.getElementById('seatingRespectLocks');
const seatingAiGenerateBtn = document.getElementById('seatingAiGenerateBtn');
const seatingAutoPlaceBtn = document.getElementById('seatingAutoPlaceBtn');
const seatingSaveBtn = document.getElementById('seatingSaveBtn');
const seatingResetBtn = document.getElementById('seatingResetBtn');
const seatingStatusEl = document.getElementById('seatingStatus');
const seatingNotesEl = document.getElementById('seatingNotes');
